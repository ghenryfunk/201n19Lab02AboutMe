...
//     `Would you like to learn more about me ${userName}? Reply 'Yes' or 'No'`
//   ).toLowerCase();
...
//   ) {
//     question1 = prompt(
//       `Please answer 'Yes' or 'No' ${userName}.`
//     ).toLowerCase();
//   }
...
//     `Do you think I'm 30 years old, ${userName}? Reply 'Yes' or 'No'`
//   ).toLowerCase();
...
//     `Do you think my armpits smell, ${userName}? Reply 'Yes' or 'No'`
//   ).toLowerCase();
...
//     `Do you think I have sweaty feet, ${userName}? Reply 'Yes' or 'No'`
//   ).toLowerCase();
...
//     `Do you think I have a sweet-tooth, ${userName}? Reply 'Yes' or 'No'`
//   ).toLowerCase();
...
//   var question6 = parseInt(
//     prompt(`What is my favorite number? You have ${guesses} guesses.`)
//   );
...
//       question6 = parseInt(
//         prompt(`Too high! You have ${guesses} guesses left.`)
//       );
//     } else if (question6 < correctNumber && guesses > 0) {
//       question6 = parseInt(
//         prompt(`Too low! You have ${guesses} guesses left.`)
//       );
...
//       question6 = parseInt(
//         prompt(`Please enter a number. You have ${guesses} guesses left.`)
//       );
//     }
//   }
...
//   var question7 = prompt(
//     `What is the greatest movie ever made, ${userName}? You have ${guesses7} guesses.`
//   ).toLowerCase();
...
//         alert(
//           `Duh! Point Break is the greatest film ever made, ${userName}! Other acceptable answers were "Point Break," and "Point Break."`
//         );
//         correctAnswer++;
...
//       question7 = prompt(
//         `Afraid not, ${userName}. C'mon, this should be an easy one! You have ${guesses7} guesses left.`
//       ).toLowerCase();
//     }
//   }
//   if (guesses7 === 0 && !answeredCorrectly7) {
//     alert(
//       `Sorry but none of those was the best movie ever made ${userName}! Acceptable answers were "Point Break," and "Point Break."`
//     );
//   }
// }
// q7();
...
// alert(
//   `Thank you for playing my guessing game, ${userName}! You got ${correctAnswer} answer(s) right. Good job!`
// );
